...
final class TrackFactory extends PersistentObjectFactory
{
    ...
    protected function defaults(): array|callable
    {
        return [
            ...
            'duration' => self::faker()->numberBetween(30, 3600),
            'isExplicitLyrics' => self::faker()->boolean(),
            'listenCount' => self::faker()->randomNumber(),
            'title' => self::faker()->words(6, true),
            'trackNum' => self::faker()->randomNumber(),
            'styles' => StyleFactory::randomRange(1, 6),
        ];
    }
